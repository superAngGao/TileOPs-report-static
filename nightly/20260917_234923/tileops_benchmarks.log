...
2 passed, 15 warnings in 13.26s
...
-- Docs: https://docs.pytest.org/en/stable/how-to/capture-warnings.html
6 passed, 14 warnings in 20.34s
...
41 tests collected in 1.83s
.....................................F...                                [100%]Benchmark report saved to profile_run.log

=================================== FAILURES ===================================
_ test_gqa_prefill_paged_with_kv_cache_fwd_bench[gqa-prefill-paged-softcap50-b4-prefix4k-chunk512-p64-float16] _

batch = 4, q_lens = [512, 512, 512, 512], cache_lens = [4096, 4096, 4096, 4096]
heads = 8, heads_kv = 2, page_size = 64, dim = 64, causal = True
fuse_rope = False, rotary_dim = None, softcap = 50.0, cache_dtype = None
dtype = torch.float16, tune = False
...
benchmarks/ops/attention/bench_gqa.py:605: 
_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 

fn = <tileops.ops.attention.gqa.GroupedQueryAttentionPrefillPagedWithKVCacheFwdOp object at 0x101d2fe6eb10>
reference = <function _fa3_gqa_prefill_paged.<locals>._run at 0x101d348b1080>
rtol = 0.001, atol = 0.001
inputs = (tensor([[[ 0.1224,  1.3906, -0.6587,  ..., -0.0832, -0.6914, -1.1475],
         [-0.6328, -1.7529,  0.0854,  ...,  0....,  ..., -1.6934, -1.3438, -1.6357]]],
       device='cuda:0', dtype=torch.float16), tensor([1.], device='cuda:0'), ...)
...
>       got, expected = fn(*inputs), reference(*inputs)
                                     ^^^^^^^^^^^^^^^^^^
E       TypeError: _fa3_gqa_prefill_paged.<locals>._run() missing 1 required positional argument: 'max_q'

benchmarks/baselines.py:247: TypeError
----------------------------- Captured stdout call -----------------------------
GQAPrefillPagedWithKVCacheFwdKernel initialized with config: {'block_m': 64, 'block_n': 64, 'num_stages': 1, 'threads': 128}
2026-09-17 18:04:25  [TileLang:tilelang.language.eager.builder:WARNING] (gqa_fwd.py:717): Immutable value `page_idx` is re-bound; use T.alloc_var to create a mutable variable.
2026-09-17 18:04:25  [TileLang:tilelang.language.eager.builder:WARNING] (gqa_fwd.py:718): Immutable value `page_offset` is re-bound; use T.alloc_var to create a mutable variable.
2026-09-17 18:04:25  [TileLang:tilelang.language.eager.builder:WARNING] (gqa_fwd.py:787): Immutable value `page_idx` is re-bound; use T.alloc_var to create a mutable variable.
2026-09-17 18:04:25  [TileLang:tilelang.language.eager.builder:WARNING] (gqa_fwd.py:788): Immutable value `page_offset` is re-bound; use T.alloc_var to create a mutable variable.
=============================== warnings summary ===============================
benchmarks/ops/attention/bench_gqa.py::test_gqa_bwd_bench[llama-8b-short-float16]
benchmarks/ops/attention/bench_gqa.py::test_gqa_bwd_bench[llama-8b-short-bfloat16]
benchmarks/ops/attention/bench_gqa.py::test_gqa_bwd_bench[llama-8b-long-float16]
...
FAILED benchmarks/ops/attention/bench_gqa.py::test_gqa_prefill_paged_with_kv_cache_fwd_bench[gqa-prefill-paged-softcap50-b4-prefix4k-chunk512-p64-float16] - TypeError: _fa3_gqa_prefill_paged.<locals>._run() missing 1 required positional argument: 'max_q'
1 failed, 40 passed, 30 warnings in 70.25s (0:01:10)
--- benchmarks/ops/attention/bench_gqa.py finished in 71s ---
...
11 tests collected in 1.92s
........sss                                                              [100%]Benchmark report saved to profile_run.log

8 passed, 3 skipped in 11.04s
--- benchmarks/ops/attention/bench_gqa_decode_paged.py finished in 11s ---

=== [6/49] benchmarks/ops/attention/bench_gqa_sliding_window_varlen.py ===
...
-- Docs: https://docs.pytest.org/en/stable/how-to/capture-warnings.html
8 passed, 8 warnings in 8.65s
--- benchmarks/ops/attention/bench_mha.py finished in 9s ---

=== [8/49] benchmarks/ops/attention/bench_mha_decode_paged.py ===
...
4 tests collected in 1.53s
....                                                                     [100%]Benchmark report saved to profile_run.log

4 passed in 35.15s
--- benchmarks/ops/attention/bench_mha_decode_paged.py finished in 36s ---

=== [9/49] benchmarks/ops/bench_ada_layer_norm.py ===
...
-- Docs: https://docs.pytest.org/en/stable/how-to/capture-warnings.html
10 passed, 14 warnings in 13.24s
--- benchmarks/ops/bench_ada_layer_norm.py finished in 14s ---

=== [10/49] benchmarks/ops/bench_argreduce.py ===
...
-- Docs: https://docs.pytest.org/en/stable/how-to/capture-warnings.html
9 passed, 58 warnings in 13.74s
--- benchmarks/ops/bench_argreduce.py finished in 14s ---

=== [11/49] benchmarks/ops/bench_batch_norm.py ===
...
-- Docs: https://docs.pytest.org/en/stable/how-to/capture-warnings.html
10 passed, 58 warnings in 17.86s
--- benchmarks/ops/bench_batch_norm.py finished in 18s ---

=== [12/49] benchmarks/ops/bench_binary_elementwise.py ===
...
-- Docs: https://docs.pytest.org/en/stable/how-to/capture-warnings.html
63 passed, 14 warnings in 50.18s
--- benchmarks/ops/bench_binary_elementwise.py finished in 51s ---

=== [13/49] benchmarks/ops/bench_bmm.py ===
...
benchmarks/ops/bench_bmm.py::test_bmm_fp8_kn_bench[square-b4-1k-per-tensor-float8_e4m3fn]
  /home/ci-runner/runner/_work/TileOPs/TileOPs/src/tileops/ops/_compile_boundary_codegen.py:187: UserWarning: BmmFp8FwdOp: b has layout [B,K,N] (shape=(4, 1024, 1024)); triggering an extra transpose(-2,-1).contiguous() DtoD copy before the fp8-TN WGMMA kernel. For best performance pass b as [B,N,K] (K-innermost) and construct with trans_b=True for the zero-copy fast path.
    result = op._eager_forward(*tensors)

benchmarks/ops/bench_bmm.py::test_bmm_fp8_kn_bench[square-b8-2k-per-tensor-float8_e4m3fn]
  /home/ci-runner/runner/_work/TileOPs/TileOPs/src/tileops/ops/_compile_boundary_codegen.py:187: UserWarning: BmmFp8FwdOp: b has layout [B,K,N] (shape=(8, 2048, 2048)); triggering an extra transpose(-2,-1).contiguous() DtoD copy before the fp8-TN WGMMA kernel. For best performance pass b as [B,N,K] (K-innermost) and construct with trans_b=True for the zero-copy fast path.
    result = op._eager_forward(*tensors)

benchmarks/ops/bench_bmm.py::test_bmm_fp8_kn_bench[mha-decode-b32-pv-per-tensor-float8_e4m3fn]
  /home/ci-runner/runner/_work/TileOPs/TileOPs/src/tileops/ops/_compile_boundary_codegen.py:187: UserWarning: BmmFp8FwdOp: b has layout [B,K,N] (shape=(32, 2048, 128)); triggering an extra transpose(-2,-1).contiguous() DtoD copy before the fp8-TN WGMMA kernel. For best performance pass b as [B,N,K] (K-innermost) and construct with trans_b=True for the zero-copy fast path.
    result = op._eager_forward(*tensors)

benchmarks/ops/bench_bmm.py::test_bmm_fp8_kn_bench[mha-decode-b64-qk-per-tensor-float8_e4m3fn]
  /home/ci-runner/runner/_work/TileOPs/TileOPs/src/tileops/ops/_compile_boundary_codegen.py:187: UserWarning: BmmFp8FwdOp: b has layout [B,K,N] (shape=(64, 128, 2048)); triggering an extra transpose(-2,-1).contiguous() DtoD copy before the fp8-TN WGMMA kernel. For best performance pass b as [B,N,K] (K-innermost) and construct with trans_b=True for the zero-copy fast path.
    result = op._eager_forward(*tensors)

benchmarks/ops/bench_bmm.py::test_bmm_fp8_kn_bench[moe-prefill-b128-per-tensor-float8_e4m3fn]
  /home/ci-runner/runner/_work/TileOPs/TileOPs/src/tileops/ops/_compile_boundary_codegen.py:187: UserWarning: BmmFp8FwdOp: b has layout [B,K,N] (shape=(128, 2048, 512)); triggering an extra transpose(-2,-1).contiguous() DtoD copy before the fp8-TN WGMMA kernel. For best performance pass b as [B,N,K] (K-innermost) and construct with trans_b=True for the zero-copy fast path.
    result = op._eager_forward(*tensors)

-- Docs: https://docs.pytest.org/en/stable/how-to/capture-warnings.html
26 passed, 49 warnings in 47.99s
--- benchmarks/ops/bench_bmm.py finished in 49s ---

=== [14/49] benchmarks/ops/bench_convolution.py ===
...
-- Docs: https://docs.pytest.org/en/stable/how-to/capture-warnings.html
55 passed, 58 warnings in 51.39s
--- benchmarks/ops/bench_convolution.py finished in 52s ---

=== [15/49] benchmarks/ops/bench_cumulative.py ===
...
-- Docs: https://docs.pytest.org/en/stable/how-to/capture-warnings.html
6 passed, 58 warnings in 12.81s
--- benchmarks/ops/bench_cumulative.py finished in 13s ---

=== [16/49] benchmarks/ops/bench_deltanet.py ===
...
-- Docs: https://docs.pytest.org/en/stable/how-to/capture-warnings.html
20 tests collected in 13.44s
....................                                                     [100%]Benchmark report saved to profile_run.log

20 passed in 13.57s
--- benchmarks/ops/bench_deltanet.py finished in 14s ---

=== [17/49] benchmarks/ops/bench_deltanet_recurrence.py ===
...
-- Docs: https://docs.pytest.org/en/stable/how-to/capture-warnings.html
8 passed, 15 warnings in 14.84s
--- benchmarks/ops/bench_deltanet_recurrence.py finished in 15s ---

=== [18/49] benchmarks/ops/bench_dropout.py ===
...
-- Docs: https://docs.pytest.org/en/stable/how-to/capture-warnings.html
3 passed, 14 warnings in 8.45s
--- benchmarks/ops/bench_dropout.py finished in 9s ---

=== [19/49] benchmarks/ops/bench_elementwise_manifest.py ===
...
-- Docs: https://docs.pytest.org/en/stable/how-to/capture-warnings.html
215 passed, 14 warnings in 127.92s (0:02:07)
--- benchmarks/ops/bench_elementwise_manifest.py finished in 128s ---

=== [20/49] benchmarks/ops/bench_engram.py ===
...
-- Docs: https://docs.pytest.org/en/stable/how-to/capture-warnings.html
9 passed, 15 warnings in 28.48s
--- benchmarks/ops/bench_engram.py finished in 29s ---

=== [21/49] benchmarks/ops/bench_fft.py ===
...
-- Docs: https://docs.pytest.org/en/stable/how-to/capture-warnings.html
1 passed, 15 warnings in 17.12s
--- benchmarks/ops/bench_fp8_lightning_indexer.py finished in 18s ---

=== [23/49] benchmarks/ops/bench_fp8_quant.py ===
...
-- Docs: https://docs.pytest.org/en/stable/how-to/capture-warnings.html
3 passed, 14 warnings in 8.85s
--- benchmarks/ops/bench_fp8_quant.py finished in 9s ---

=== [24/49] benchmarks/ops/bench_fused_moe_experts.py ===
...
16 passed in 213.87s (0:03:33)
--- benchmarks/ops/bench_fused_moe_experts.py finished in 214s ---
...
-- Docs: https://docs.pytest.org/en/stable/how-to/capture-warnings.html
37 passed, 58 warnings in 205.00s (0:03:24)
--- benchmarks/ops/bench_gemm.py finished in 206s ---
...
-- Docs: https://docs.pytest.org/en/stable/how-to/capture-warnings.html
8 passed, 8 xpassed, 56 warnings in 12.11s
--- benchmarks/ops/bench_gla_chunkwise.py finished in 13s ---
...
-- Docs: https://docs.pytest.org/en/stable/how-to/capture-warnings.html
8 passed, 58 warnings in 15.16s
...
-- Docs: https://docs.pytest.org/en/stable/how-to/capture-warnings.html
4 passed, 18 warnings in 12.38s
...
-- Docs: https://docs.pytest.org/en/stable/how-to/capture-warnings.html
23 passed, 14 warnings in 22.33s
...
-- Docs: https://docs.pytest.org/en/stable/how-to/capture-warnings.html
8 passed, 58 warnings in 14.34s
...
-- Docs: https://docs.pytest.org/en/stable/how-to/capture-warnings.html
10 passed, 58 warnings in 17.56s
--- benchmarks/ops/bench_logical_reduce.py finished in 18s ---
...
-- Docs: https://docs.pytest.org/en/stable/how-to/capture-warnings.html
27 passed, 15 warnings in 75.49s (0:01:15)
--- benchmarks/ops/bench_mamba.py finished in 76s ---
...
-- Docs: https://docs.pytest.org/en/stable/how-to/capture-warnings.html
8 passed, 15 warnings in 41.47s
--- benchmarks/ops/bench_mamba2_e2e.py finished in 42s ---
...
-- Docs: https://docs.pytest.org/en/stable/how-to/capture-warnings.html
5 passed, 14 warnings in 23.43s
--- benchmarks/ops/bench_mean_pooling.py finished in 24s ---
...
-- Docs: https://docs.pytest.org/en/stable/how-to/capture-warnings.html
6 passed, 15 warnings in 15.15s
...
-- Docs: https://docs.pytest.org/en/stable/how-to/capture-warnings.html
6 tests collected in 11.57s
......                                                                   [100%]Benchmark report saved to profile_run.log

6 passed in 19.72s
--- benchmarks/ops/bench_moe_fused_moe.py finished in 20s ---

=== [38/49] benchmarks/ops/bench_moe_fused_topk.py ===
...
-- Docs: https://docs.pytest.org/en/stable/how-to/capture-warnings.html
7 tests collected in 11.42s
.......                                                                  [100%]Benchmark report saved to profile_run.log

7 passed in 7.98s
--- benchmarks/ops/bench_moe_fused_topk.py finished in 9s ---

=== [39/49] benchmarks/ops/bench_moe_permute_align.py ===
...
12 tests collected in 1.49s
............                                                             [100%]Benchmark report saved to profile_run.log

12 passed in 9.04s
--- benchmarks/ops/bench_moe_permute_align.py finished in 9s ---

=== [40/49] benchmarks/ops/bench_moe_shared_fused_moe.py ===
benchmarks/ops/bench_moe_shared_fused_moe.py::test_shared_fused_moe_bench[kimi-k2-t1]
benchmarks/ops/bench_moe_shared_fused_moe.py::test_shared_fused_moe_bench[kimi-k2-t32]
benchmarks/ops/bench_moe_shared_fused_moe.py::test_shared_fused_moe_bench[kimi-k2-t64]
benchmarks/ops/bench_moe_shared_fused_moe.py::test_shared_fused_moe_bench[kimi-k2-t128]
benchmarks/ops/bench_moe_shared_fused_moe.py::test_shared_fused_moe_bench[kimi-k2-t512]
benchmarks/ops/bench_moe_shared_fused_moe.py::test_shared_fused_moe_bench[kimi-k2-t2048]
benchmarks/ops/bench_moe_shared_fused_moe.py::test_shared_fused_moe_bench[kimi-k2-t4096]
benchmarks/ops/bench_moe_shared_fused_moe.py::test_shared_fused_moe_bench[deepseek-v3-t1]
benchmarks/ops/bench_moe_shared_fused_moe.py::test_shared_fused_moe_bench[deepseek-v3-t32]
benchmarks/ops/bench_moe_shared_fused_moe.py::test_shared_fused_moe_bench[deepseek-v3-t64]
benchmarks/ops/bench_moe_shared_fused_moe.py::test_shared_fused_moe_bench[deepseek-v3-t128]
benchmarks/ops/bench_moe_shared_fused_moe.py::test_shared_fused_moe_bench[deepseek-v3-t512]
benchmarks/ops/bench_moe_shared_fused_moe.py::test_shared_fused_moe_bench[deepseek-v3-t2048]
benchmarks/ops/bench_moe_shared_fused_moe.py::test_shared_fused_moe_bench[deepseek-v3-t4096]
benchmarks/ops/bench_moe_shared_fused_moe.py::test_shared_fused_moe_bench[glm-4.5-t1]
benchmarks/ops/bench_moe_shared_fused_moe.py::test_shared_fused_moe_bench[glm-4.5-t32]
benchmarks/ops/bench_moe_shared_fused_moe.py::test_shared_fused_moe_bench[glm-4.5-t64]
benchmarks/ops/bench_moe_shared_fused_moe.py::test_shared_fused_moe_bench[glm-4.5-t128]
benchmarks/ops/bench_moe_shared_fused_moe.py::test_shared_fused_moe_bench[glm-4.5-t512]
benchmarks/ops/bench_moe_shared_fused_moe.py::test_shared_fused_moe_bench[glm-4.5-t2048]
benchmarks/ops/bench_moe_shared_fused_moe.py::test_shared_fused_moe_bench[glm-4.5-t4096]
...
-- Docs: https://docs.pytest.org/en/stable/how-to/capture-warnings.html
21 tests collected in 11.51s
.....................                                                    [100%]Benchmark report saved to profile_run.log

21 passed in 543.75s (0:09:03)
--- benchmarks/ops/bench_moe_shared_fused_moe.py finished in 544s ---
...
-- Docs: https://docs.pytest.org/en/stable/how-to/capture-warnings.html
22 tests collected in 11.65s
......................                                                   [100%]Benchmark report saved to profile_run.log

22 passed in 81.62s (0:01:21)
--- benchmarks/ops/bench_moe_staged.py finished in 82s ---
...
-- Docs: https://docs.pytest.org/en/stable/how-to/capture-warnings.html
33 passed, 58 warnings in 43.87s
...
-- Docs: https://docs.pytest.org/en/stable/how-to/capture-warnings.html
48 passed, 58 warnings in 65.30s (0:01:05)
--- benchmarks/ops/bench_pool.py finished in 66s ---
...
-- Docs: https://docs.pytest.org/en/stable/how-to/capture-warnings.html
33 passed, 58 warnings in 33.49s
--- benchmarks/ops/bench_reduce.py finished in 34s ---
...
-- Docs: https://docs.pytest.org/en/stable/how-to/capture-warnings.html
13 passed, 14 warnings in 14.22s
...
-- Docs: https://docs.pytest.org/en/stable/how-to/capture-warnings.html
20 passed, 58 warnings in 27.51s
...
-- Docs: https://docs.pytest.org/en/stable/how-to/capture-warnings.html
2 passed, 14 warnings in 146.24s (0:02:26)
--- benchmarks/ops/bench_topk_selector.py finished in 147s ---
...
-- Docs: https://docs.pytest.org/en/stable/how-to/capture-warnings.html
107 passed, 14 warnings in 63.90s (0:01:03)
